...
public class Service2 {
    ...
    public ResponseEntity<ArrayList<LinkedList<Ship>>> getTimetable() {
        ...
        System.out.println('\n');
        System.out.print("Добавление кораблей вручную (да/нет): ");
        String answer = in.next();
        while(!answer.equals("да") && !answer.equals("нет") && !answer.equals("no")) {
        ...
        String fileName = resourcesPath + "timetable.json";
        try {
    ...
    public ResponseEntity<String> getTimetable() {
        ...
        Gson gson = new GsonBuilder().setPrettyPrinting().create();
        ArrayList<LinkedList<Ship>> timetable = gson.fromJson(responseEntity.getBody(), listOfShips);
        String fileName = resourcesPath + "timetable-" + UUID.randomUUID() + ".json";
